...
class MyParse(object):
    def __init__(self):
        ...
        self.__parser.add_argument('--epochs', default=150, type=int, help="total epoch needed to run")
        self.__parser.add_argument('--train_batch_size', default=256, type=int, help="batch size on training set")
        self.__parser.add_argument('--val_batch_size', default=256, type=int, help="batch size on validation set")
        self.__parser.add_argument('--test_batch_size', default=256, type=int, help="batch size on validation set")
        ...
        self.__parser.add_argument('--lr', default=1e-4, help="learning rate")
